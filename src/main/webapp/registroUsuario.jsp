...
<head>
    ...
    <title>Gesti�n de Usuarios - AresFitness</title>
    ...
    <div class="admin-container">
        ...
        <header class="admin-header">
            <div class="header-content">
                <h1>Gesti�n de Usuarios - AresFitness</h1>
                <div class="user-info">
                ...
                <form id="user-form">
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="dni" class="form-input" required maxlength="8" pattern="[0-9]{8}" title="El DNI debe tener 8 dígitos">
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="fechaContratacion">Fecha de contrataci�n *</label>
                    ...
                    <div class="form-group form-checkbox">
                        ...
                        <label for="sendEmail">Enviar credenciales por correo electrónico</label>
                    </div>

                    <div class="form-group form-checkbox">
                        <input type="checkbox" id="forcePasswordChange">
                        <label for="forcePasswordChange">Forzar cambio de contraseña en primer inicio</label>
                    </div>
