...
<html lang="es">
    ...
    <body>
            ...
            <div class="header-container">
                ...
                <div class="header-actions">
                    ...
                    <div class="auth-dropdown" id="authDropdown">
                        <a href="login.jsp">
                            <i class="fas fa-sign-in-alt"></i> Iniciar Sesón
                        </a>
                        <a href="registro.jsp">
            ...
            <section class="hero-location" style="background: linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url('Recursos/Imagenes/extencion.jpg') no-repeat center center/cover;">
                <div class="hero-overlay">
                    <div class="hero-content">
                        <h1>ENCÁNTRANOS FÁCILMENTE</h1>
                        <p>Ven y conoce nuestras modernas instalaciones en un lugar estratágico de la ciudad</p>
                    </div>
                </div>
            </section>
       ...
       <script>
// JavaScript para controlar la visualizaci�n del men� desplegable
